...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .bs_requests, .bs_requests button {
                margin: 20px;
            }
        </style>
    </head>
    <body class="antialiased">
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div id="form" class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="p-6">
                        <form action="/thank-you" method="post">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="date" name="bs_date" id="bs_date" required></td>
                                </tr>
                                <tr>
                                    <td>Bible Study Time:</td>
                                    <td><input type="time" name="bs_time" id="bs_time" required></td>
                                </tr>
                                <tr>
